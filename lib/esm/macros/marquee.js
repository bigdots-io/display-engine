...
export const startMarquee = async ({ macroConfig, dimensions, ctx, index, updatePixels, }) => {
    const config = Object.assign({ color: "#fff", text: "Replace with marquee text!", font: "Arial", fontSize: 12, speed: 50, width: dimensions.width, height: dimensions.height, startingColumn: 0, startingRow: 0, brightness: 10, direction: "vertical" }, macroConfig);
