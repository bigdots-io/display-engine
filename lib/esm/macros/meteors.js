...
export const startMeteors = async ({ macroConfig, dimensions, index, ctx, updatePixels, }) => {
    const config = Object.assign({ color: "#FFF", meteorCount: 40, maxTailLength: 20, minTailLength: 5, maxDepth: 5, minSpeed: 100, maxSpeed: 10, width: dimensions.width, height: dimensions.height, brightness: 10 }, macroConfig);
    const meteors = [];
