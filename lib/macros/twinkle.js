...
export var startTwinkleMacro = function (config, dimensions, macroIndex, onPixelChange) {
    ...
    for (var y = 0; y < height; y++) {
        for (var x = 0; x < width; x++) {
            onPixelChange({ y: y, x: x, hex: randomColorShade(shades), macroIndex: macroIndex });
        }
    }
